...
import (
	...
	examplecomv1 "github.com/vitorfloriano/wordpress-operator-poc/api/v1"
	"github.com/vitorfloriano/wordpress-operator-poc/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dc5d92c6.my.domain",
